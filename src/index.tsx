          ...
          <Box>
            <div className="content">
              ...
              <p>
                ...
                soundscape/electronica works. Also produces works for games and
                film.
              </p>
            </div>
            <SocialIcon
        ...
        <div className="column is-4">
          <Box>
            <div className="content">
              <h2>Games</h2>
              <p>
                Independent game developer creating weird and wonderful games,
                with the occasional excremental experience.
              </p>
            </div>
            <SocialIcon
